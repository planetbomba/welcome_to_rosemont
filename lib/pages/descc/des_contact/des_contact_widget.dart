...
import 'des_contact_model.dart';
export 'des_contact_model.dart';

class DesContactWidget extends StatefulWidget {
  const DesContactWidget({super.key});

  @override
  State<DesContactWidget> createState() => _DesContactWidgetState();
}
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final desContactGetPageResponse = snapshot.data!;
                    ...
                    ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        ...
                        imageUrl: functions.getImage(getJsonField(
                          desContactGetPageResponse.jsonBody,
                          r'''$.data[0].image''',
                        ).toString())!,
                        width: 300.0,
                        height: 200.0,
